...
# Overview:
A recognized investment bank is entering the cryptocurrency market and is interested in learning how to implement this new type of currency in its portfolio options. A report is created using unsupervised machine learning, clustering algorithms, and visualizations to display which cryptocurrencies are currently on the trading market and how they can be classified for different types of investment strategies.
...
Using the StandardScaler algorithm, the cryptocurrency dataframe is scaled in preparation for the Principal Componenent Analysis (PCA) algorithm. PCA reduces the dimensions of the dataframe to, in this case, three principal components (PC1, PC2, PC3). Reducing dimensions assists machines running the algorithms to run faster and more efficiently by transforming a large dataset into consolidated relational data without compromising the directionality of the original datasource.   
...
The data is once again cleaned and formatted into a table showing only 532 currently tradable cryptocurrencies: 
...
The scaled tradable cryptocurrencies table is further sorted for Total Coins Supply and Total Coins Mined. A final scatter plot displays the relationship between these two variables.:
